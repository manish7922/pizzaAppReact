...
class OtherItems extends Component {
  ...
  render() {
    ...
    let cartIndex = otherItems.findIndex((n) => n.name === name);
            ...
            {cart.map((n) => (
              <>
                <div className="row border">
                  ...
                  <div className="col-8">
                    <h6 className="text-center" style={{ marginLeft: "-10%" }}>
                      {n.name}
                    </h6>
                    <div className="row">
                      {n.size} {n.crust}
